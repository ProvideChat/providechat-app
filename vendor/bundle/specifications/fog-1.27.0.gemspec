...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<fog-core>, [">= 1.27.3", "~> 1.27"])
      ...
      s.add_development_dependency(%q<rbovirt>, ["= 0.0.31"])
      ...
      s.add_dependency(%q<fog-core>, [">= 1.27.3", "~> 1.27"])
      ...
      s.add_dependency(%q<rbovirt>, ["= 0.0.31"])
