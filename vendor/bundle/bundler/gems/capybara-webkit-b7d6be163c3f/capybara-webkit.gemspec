# -*- encoding: utf-8 -*-
# stub: capybara-webkit 1.1.1 ruby lib
# stub: extconf.rb
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<capybara>, ["< 2.2.0", ">= 2.0.2"])
      ...
      s.add_dependency(%q<capybara>, ["< 2.2.0", ">= 2.0.2"])
